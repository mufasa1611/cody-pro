...
if defined CODY_PRO_INSTALL_ROOT set "ROOT=%CODY_PRO_INSTALL_ROOT%"
...
call :SelfUpdate %*
if defined CODY_PRO_SELF_UPDATE_EXIT exit /b %CODY_PRO_SELF_UPDATE_EXIT%
...
:SelfUpdate
if "%CODY_PRO_INSTALLER_SELF_UPDATED%"=="1" exit /b 0
...
set "CODY_PRO_INSTALLER_SELF_UPDATED=1"
set "CODY_PRO_INSTALL_ROOT=%ROOT%"
call "%LATEST_INSTALLER%" %*
set "CODY_PRO_SELF_UPDATE_EXIT=%ERRORLEVEL%"
del "%LATEST_INSTALLER%" >nul 2>nul
exit /b 0
