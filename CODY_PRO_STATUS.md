...
Update on 2026-05-14: the longer full suite command was tried again and still timed out before useful output was emitted. The current reliable gate is `bun run typecheck` plus focused smoke tests in `CODY_PRO_TEST_LOG.md`.
