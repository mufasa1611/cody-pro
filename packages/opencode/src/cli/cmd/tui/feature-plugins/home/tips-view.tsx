...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your Cody Pro conversation",
  ...
  "Place TUI settings in your global config directory for all Cody Pro sessions",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Cody Pro auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Cody Pro auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Cody Pro uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Cody Pro from reading sensitive files",
  "Use {highlight}cody-pro run{/highlight} for non-interactive scripting",
  "Use {highlight}cody-pro --continue{/highlight} to resume the last session",
  "Use {highlight}cody-pro run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}cody-pro serve{/highlight} for headless API access to Cody Pro",
  "Use {highlight}cody-pro run --attach{/highlight} to connect to a running server",
  "Run {highlight}cody-pro upgrade{/highlight} to update to the latest version",
  "Run {highlight}cody-pro auth list{/highlight} to see all configured providers",
  "Run {highlight}cody-pro agent create{/highlight} for guided agent creation",
  "Use {highlight}/cody-pro{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}cody-pro github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/cody-pro fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/cody-pro{/highlight} on PR code lines for targeted code reviews",
  ...
  "Run {highlight}cody-pro debug config{/highlight} to troubleshoot configuration",
  ...
  "Use the Cody Pro container image for containerized use when published",
  "Use {highlight}/connect{/highlight} with Cody Pro for curated, tested models",
